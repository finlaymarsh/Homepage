...
class BubbleSortApi extends SortingAlgorithmApi {
    ...
    sortList(){
        ...
        fetch('http://localhost:8080/api/sorting-algorithms/bubble-sort', requestOptions)
